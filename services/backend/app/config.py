...
class Settings(BaseModel):
    ...
    analyst_model: str = os.getenv("ANALYST_MODEL", "llama3.2:3b")
    ...
    analyst_timeout_seconds: int = int(
        os.getenv("ANALYST_TIMEOUT_SECONDS", os.getenv("AGENT_TIMEOUT_SECONDS", "120"))
    )
